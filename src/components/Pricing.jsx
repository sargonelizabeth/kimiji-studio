export default function Pricing() {
  ...
  const name = { fontFamily:"Sandoll GothicNeoRound", fontWeight:700, margin:0, fontSize:16, letterSpacing:"-0.01em" };
  const price= { fontFamily:"Sandoll GothicNeoRound", fontWeight:700, margin:"8px 0 0", fontSize:22 };
  const small= { fontFamily:"Sandoll GothicNeoRound", fontWeight:400, margin:"6px 0 0", opacity:.85, fontSize:12 };
  ...
  return (
    <section style={wrap}>
      <div style={grid}>
        ...
        <div style={box}>
          <h4 style={name}>스튜디오 사진 3장 + 영상 1개</h4>
          <p style={price}>99,000원</p>
