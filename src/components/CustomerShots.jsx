...
export default function CustomerShots() {
  ...
  const title = { fontFamily:"Sandoll GothicNeoRound", fontWeight:700, fontSize:"clamp(18px,4vw,28px)", margin:"0 0 12px" };
  const desc  = { fontFamily:"Sandoll GothicNeoRound", fontWeight:400, fontSize:12, opacity:.85, margin:"0 0 16px" };
